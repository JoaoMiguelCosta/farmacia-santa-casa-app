...
import { getSantaCasaRegularizacoesHistorico } from "../api/santaCasaRegularizacoesApi";
...
export function useSantaCasaRegularizacoesHistoricoUtente() {
  ...
  const loadHistorico = useCallback(
    async ({ showRefreshing = false } = {}) => {
      ...
      try {
        const result = await getSantaCasaRegularizacoesHistorico({
          ...DEFAULT_QUERY,
          utenteId,
        });
