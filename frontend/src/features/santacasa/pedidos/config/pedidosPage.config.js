...
export const PEDIDOS_PAGE = Object.freeze({
  ...
  detail: {
    ...
    description:
      "Consulta os utentes, os medicamentos, as quantidades e os dados das receitas incluídos neste pedido.",
    ...
    summaryDescription: "Informação geral do pedido enviado para a Farmácia.",

    warningTitle: "Pedido com medicamentos cancelados por expiração",

    warningDescription:
      "Alguns medicamentos já não serão incluídos porque a validade da receita terminou antes da decisão da Farmácia.",

    summary: {
      ariaLabel: "Resumo do pedido",
  ...
  sections: {
    ...
    pending: {
      ...
      countAriaLabel: "Total de pedidos pendentes: {count}",
      ...
      paginationAriaLabel: "Paginação de pedidos pendentes",
